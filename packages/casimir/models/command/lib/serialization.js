...
import DeleteNftCollectionMetadataCmd from './impl/DeleteNftCollectionMetadataCmd';
...
import UpdateNftItemMetadataDraftModerationMsgCmd from './impl/UpdateNftItemMetadataDraftModerationMsgCmd';
...
const APP_CMD_INFO = {
  ...
  [APP_CMD.DELETE_NFT_COLLECTION_METADATA]: { class: DeleteNftCollectionMetadataCmd },
  ...
  // eslint-disable-next-line max-len
  [APP_CMD.UPDATE_NFT_ITEM_METADATA_DRAFT_MODERATION_MSG]: { class: UpdateNftItemMetadataDraftModerationMsgCmd }
};
