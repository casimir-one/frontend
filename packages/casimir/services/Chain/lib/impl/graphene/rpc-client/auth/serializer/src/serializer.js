...
var Serializer = function () {
    function Serializer(operation_name, types, _ref) {
        var _ref$nosort = _ref.nosort,
            nosort = _ref$nosort === undefined ? false : _ref$nosort,
            _ref$entity_external_ = _ref.entity_external_id,
            entity_external_id = _ref$entity_external_ === undefined ? null : _ref$entity_external_;
    ...
    _createClass(Serializer, [{
        ...
        */
        ...
        key: 'toEntityExternalIdByteBuffer',
        value: function toEntityExternalIdByteBuffer(object, _ref2) {
            var _this = this;
            ...
            var field = null;
            try {
                var iterable = this.keys.filter(function (k) {
                    return k != _this.entity_external_id;
                });
                for (var i = 0, field; i < iterable.length; i++) {
                    field = iterable[i];
                    var type = this.types[field];
        ...
        key: 'toEntityExternalIdBuffer',
        value: function toEntityExternalIdBuffer(object, _ref3) {
            var refBlockNum = _ref3.refBlockNum,
                refBlockPrefix = _ref3.refBlockPrefix;

            if (!refBlockNum || !refBlockPrefix) {
                throw new Error("Reference summary is required for TaPoS");
            }
            return new Buffer(this.toEntityExternalIdByteBuffer(object, { refBlockNum: refBlockNum, refBlockPrefix: refBlockPrefix }).toBinary(), 'binary');
        }
    }]);
