...
exports = module.exports = function (deipBroadcast) {
    deipBroadcast.addAccountAuth = function (_ref, cb) {
        var signingKey = _ref.signingKey,
            username = _ref.username,
            authorizedUsername = _ref.authorizedUsername,
            _ref$role = _ref.role,
            role = _ref$role === undefined ? 'active' : _ref$role,
            weight = _ref.weight;
        ...
        _api2.default.getAccounts([username], function (err, _ref2) {
            ...
            deipBroadcast.accountUpdate(signingKey, userAccount.name, owner, active, userAccount.memo_key, userAccount.json_metadata, cb);
        });
    };

    deipBroadcast.removeAccountAuth = function (_ref4, cb) {
        var signingKey = _ref4.signingKey,
            username = _ref4.username,
            authorizedUsername = _ref4.authorizedUsername,
            _ref4$role = _ref4.role,
            role = _ref4$role === undefined ? 'active' : _ref4$role;
