...
var Deip = function (_EventEmitter) {
    _inherits(Deip, _EventEmitter);

    function Deip() {
        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

        _classCallCheck(this, Deip);

        var _this = _possibleConstructorReturn(this, (Deip.__proto__ || Object.getPrototypeOf(Deip)).call(this, options));
...
var deip = new Deip(_config2.default);
