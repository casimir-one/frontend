...
var debug = (0, _debug2.default)('deip:broadcast');
...
deipBroadcast.send = function deipBroadcast$send(tx, privKeys, callback) {
    var resultP = deipBroadcast._prepareTransaction(tx).then(function (transaction) {
...
_operations2.default.forEach(function (operation) {
    ...
    deipBroadcast[operationName + 'With'] = function deipBroadcast$specializedSendWith(wif, options, callback) {
    ...
    deipBroadcast[operationName] = function deipBroadcast$specializedSend(wif) {
...
(0, _helpers2.default)(deipBroadcast);

_bluebird2.default.promisifyAll(deipBroadcast);
