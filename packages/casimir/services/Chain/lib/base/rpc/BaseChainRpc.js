...
const ChainRpc = Interface('ChainRpc', {
  ...
  getDomainAsync: async function (externalId) { },
  ...
  getReviewsByProjectContentAsync: async function (projectContentExternalId, startIdx = defaultIdx, limit = defaultLimit) { },
  getReviewsByProjectAsync: async function (projectExternalId, startIdx = defaultIdx, limit = defaultLimit) { },
