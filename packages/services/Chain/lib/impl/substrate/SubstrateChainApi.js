...
class SubstrateChainApi extends BaseChainApi {
  ...
  constructor(chainService) {
    const api = {
      ...
      getTeamByIdAsync: async function (id) { throw Error(`Not implemented exception`); },
      ...
      getProjectContentByIdAsync: async function (id) { throw Error(`Not implemented exception`); },
      ...
      getProjectTokenSaleByIdAsync: async function (tokenSaleId) { throw Error(`Not implemented exception`); },
      getProjectTokenSalesByProjectAsync: async function (projectExternalId) { throw Error(`Not implemented exception`); },
      getProjectTokenSalesByProjectIdAsync: async function (projectId) { throw Error(`Not implemented exception`); },
      ...
      getProjectTokenSaleContributionsByProjectTokenSaleIdAsync: async function (tokenSaleId) { throw Error(`Not implemented exception`); },
      ...
      getReviewByIdAsync: async function (reviewId) { throw Error(`Not implemented exception`); },
      ...
      getProjectTokenByIdAsync: async function (projectTokenId) { throw Error(`Not implemented exception`); },
      ...
      getContributionsHistoryByContributorAsync: async function (contributor) { throw Error(`Not implemented exception`); },
      getContributionsHistoryByContributorAndProjectAsync: async function (contributor, projectId) { throw Error(`Not implemented exception`); },
